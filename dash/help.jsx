  ...
  const KB = [
    ...
    { cat: 'Campaigns', items: [
      { t: 'Creating your first campaign', body: [
        'Go to Campaigns → Create campaign. Choose recipients (or a saved List), write your sequence of steps, and choose When I publish or After N days. Step 1 is never sent at launch — open the campaign and click Publish when you are ready.',
    ...
    { cat: 'Billing & Plans', items: [
      ...
      { t: 'How to upgrade to Pro', body: [
        'Click Upgrade anywhere you see it (or the banner in the sidebar). Peekd opens checkout so you can pay $7/month with Paddle, Stripe, or PayPal, or $70/year with PayPal — whichever methods are enabled.',
